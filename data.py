...
vector_5 = model[words[4]][0:3]
vector_6 = model[words[5]][0:3]
...
ax.text(vector_5[0], vector_5[1], vector_5[2], words[4])
ax.text(vector_6[0], vector_6[1], vector_6[2], words[5])
...
soa = np.array([[0, 0, 0, vector_1[0], vector_1[1], vector_1[2]], 
                ...
                [0, 0, 0, vector_5[0], vector_5[1], vector_5[2]],
